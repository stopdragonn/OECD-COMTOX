...
from utils.data_loader.md_loader import load_data
...
def main(fingerprint_type, file_path, model_save_path, scaler_save_path):
    ...
    x, y, scaler = load_data(file_path=file_path, fingerprint_type=fingerprint_type, scaler_save_path=scaler_save_path)
    ...
    # 최적 모델 저장
    model_filename = f'{model_save_path}/best_model_{fingerprint_type}_gbt.joblib'
